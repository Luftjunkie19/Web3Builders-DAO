...
module.exports = {
    ...
    execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const checkAbilityResponse = yield fetch(`http://localhost:2137/gov_token/influence/${interaction.user.id}`);
                ...
                buttonCollector === null || buttonCollector === void 0 ? void 0 : buttonCollector.on('collect', (i) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        if (i.customId === 'finalStep') {
                            ...
                            yield i.deferUpdate();
                            const request = yield Promise.race([yield fetch(`http://localhost:2137/gov_token/intial_token_distribution/${interaction.user.id}`, {
                                    method: 'POST',
                                    headers: {
