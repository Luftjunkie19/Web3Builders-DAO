...
exports.getResponseFromBobert = getResponseFromBobert;
exports.getImageResponse = getImageResponse;
const genai_1 = require("@google/genai");
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const ai = new genai_1.GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY });
function getResponseFromBobert(input) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const textualBobert = yield ai.models.generateContent({ 'model': 'gemini-2.5-flash-preview-05-20', 'contents': input, config: {
...
function getImageResponse(contents) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d;
        {
            try {
                ...
                if (!response || !response.candidates || !((_b = (_a = response.candidates[0]) === null || _a === void 0 ? void 0 : _a.content) === null || _b === void 0 ? void 0 : _b.parts)) {
                ...
                for (const part of response.candidates[0].content.parts) {
                    ...
                    if (part.text) {
                        ...
                        return {
                            ...
                            name: (_c = part.fileData) === null || _c === void 0 ? void 0 : _c.displayName,
                            fileURI: (_d = part.fileData) === null || _d === void 0 ? void 0 : _d.fileUri,
                            buffer
                        };
                    }
                }
