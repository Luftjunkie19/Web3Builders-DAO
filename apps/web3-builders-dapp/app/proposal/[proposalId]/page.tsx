...
import Comment from '@/components/proposal/comment/Comment'
import CommentList from '@/components/proposal/comment/CommentList'
...
<div className="flex items-center gap-2">
  <p className='text-white text-sm'>4 hours ago</p>
</div>
</div>
...
<ProposalCallbackItem icon={PiHandCoinsFill} callbackText={"1000 Reward For @username"} />
<ProposalCallbackItem icon={PiHandCoinsFill} callbackText={"1000 Reward For @username"} />
<ProposalCallbackItem icon={PiHandCoinsFill} callbackText={"1000 Reward For @username"} />
<ProposalCallbackItem icon={PiHandCoinsFill} callbackText={"1000 Reward For @username"} />
<ProposalCallbackItem icon={PiHandCoinsFill} callbackText={"1000 Reward For @username"} />
...
<ProposalCommentBar state={state}/>
