...
const {data:proposals,error} = await supabase.from(`dao_proposals`).select('*, dao_members!inner(*), dao_vote_options:dao_vote_options(*), calldata_objects:calldata_objects(*)');
