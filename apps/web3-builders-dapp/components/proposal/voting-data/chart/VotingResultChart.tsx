...
function VotingResultChart({chartData, isCustom}: Props) {
  return (
    <ChartContainer config={isCustom ? customVotingChartConfig : standardVotingChartConfig} className={`w-full p-2 bg-zinc-800 border border-(--hacker-green-4) rounded-lg max-w-lg lg:max-w-md min-h-72`}>
