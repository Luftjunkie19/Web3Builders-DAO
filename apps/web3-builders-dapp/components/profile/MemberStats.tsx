...
type Props = {walletAddress:`0x${string}`,isOpen:boolean, monthActivities:any[]

};

function MemberStats({walletAddress,isOpen, monthActivities}: Props) {
...
{userVotes && userVotedProposalsCount && (userVotes as any[]).length > 0 &&( userVotedProposalsCount as any) &&   Number((userVotedProposalsCount as BigInt)) > 0 && Number((userVotedProposalsCount as any)) > 0 &&
<div className=
